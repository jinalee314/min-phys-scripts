...
MODIFIED AUG 2025 by jinalee314 for Mg-O-Fe-Ne system
...
parser.add_argument('--ele',"-e", type=str,nargs="+",default = ['Mg','O','Fe','Ne'],help="elements")
parser.add_argument('--file',"-f", type=str,nargs="+",
                    default = ['refmg-local.xyz','refo-local.xyz',
                               'reffe-local.xyz','refne-local.xyz'],help="path to file")
