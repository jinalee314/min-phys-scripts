...
parser.add_argument("--num_interface_w","-nw",type=float,help="Default: larger, btetter, must set!")
...
try:
    ...
    sys.path.insert(1, '/Users/jiedeng/opt/anaconda3/lib/python3.9/mldp/similarity/')
except:
    print("run in local")
...
ana=GDSAnalyzer(xyz = xyz, begin = args.begin, end = args.end, mode = args.mode, project_axis= args.project_axis, step = args.step,nw=args.num_interface_w,alpha=0.5)
